...
import 'package:skyhospital_erp/screens/Philebotomy/patientSamples.comp.dart';
...
class phlebotomy extends StatefulWidget {
  const phlebotomy({super.key});

  @override
  State<phlebotomy> createState() => _phlebotomyState();
}

class _phlebotomyState extends State<phlebotomy> {
  @override
          ...
          Flex(
            ...
            children: [
              if (Responsive.isDesktop(context)) ...[
                Expanded(child: tile2(tileHeading: "New Order", tileData: "2")),
                Expanded(
                    child:
                        tile2(tileHeading: "Samples Collected", tileData: "0")),
                Expanded(
                    child:
                        tile2(tileHeading: "Dispatch to Lab", tileData: "0")),
                Expanded(
                    child: Container(
              ...
              if (!Responsive.isDesktop(context)) ...[
                Container(
                    ...
                    child: tile2(tileHeading: "New Order", tileData: "2")),
                Container(
                    ...
                    child: tile2(
                        tileHeading: "Samples Collected", tileData: "24")),
                Container(
                    width: MediaQuery.of(context).size.width,
                    margin: EdgeInsets.only(
                      right: Insets().appPadding,
