...
class interviewFiles extends StatefulWidget {
  interviewFiles({super.key});

  @override
  State<interviewFiles> createState() => _interviewFilesState();
}

class _interviewFilesState extends State<interviewFiles> {
  bool _addFile = false;
  @override
