...
class applicantNote extends StatefulWidget {
  applicantNote({super.key});

  @override
  State<applicantNote> createState() => _applicantNoteState();
}

class _applicantNoteState extends State<applicantNote> {
                    ...
                    child: InkWell(
                      ...
                      child: Row(
                        children: [
                          ...
                          Heading4(
                              value: "Add Note", color: Palette().primaryColor),
                        ],
                      ),
                    ),
                  ),
                        ...
                        Container(
                          ...
                          child: SizedBox(
                              ...
                              child: Column(
                                children: [
                                  inputTextField(
                                      title: "Tilte", hintText: "Title"),
                                  SizedBox(
                                    height: 20,
                                  ),
                                  inputBigText(title: "Note", hintText: ""),
                                  Row(
