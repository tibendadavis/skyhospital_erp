...
class addOfferLetter extends StatefulWidget {
  const addOfferLetter({super.key});

  @override
  State<addOfferLetter> createState() => addOfferLetterState();
}

class addOfferLetterState extends State<addOfferLetter>
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              inputDate(
                                  heading: "Offer Expires On",
                                  subheading: "Date"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              inputDate(
                                  heading: "Expected Joining Date",
                                  subheading: "Date"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              inputTextField(title: "Salary", hintText: "0"),
                              SizedBox(
                                height: Responsive.isDesktop(context) ? 10 : 15,
                              ),
                              Row(
