...
class addInterviewSchedule extends StatefulWidget {
  bool? reschudle;
  addInterviewSchedule({super.key, this.reschudle});

  @override
  State<addInterviewSchedule> createState() => addInterviewScheduleState();
}

class addInterviewScheduleState extends State<addInterviewSchedule>
                          ...
                          child: Column(
                            ...
                            children: [
                              if (widget.reschudle == null) ...[
                                ...
                                inputDate(
                                    heading: "Start On", subheading: "Date"),
                                SizedBox(
                                  height:
                                      Responsive.isDesktop(context) ? 10 : 15,
                                ),
                                inputTime1(
                                    heading: "Start Time", subheading1: "Time"),
                                SizedBox(
                                  height:
                                      Responsive.isDesktop(context) ? 10 : 15,
                                ),
                                inputBigText(title: "Comment", hintText: ""),
                                SizedBox(
                                  height:
                                      Responsive.isDesktop(context) ? 10 : 15,
                                ),
