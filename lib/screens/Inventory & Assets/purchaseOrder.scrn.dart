...
import 'package:skyhospital_erp/screens/Inventory%20&%20Assets/addPurchaseOrder.scrn.dart';
    ...
    return Container(
      child: Expanded(
        ...
        children: [
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  Expanded(
                    ...
                    linkTitle: "New Purchase Order",
                  )),
                  Expanded(
                      child: tile2(
                    tileHeading: "Total Purchase Orders",
                    tileData: "7",
                  )),
                ],
                if (!Responsive.isDesktop(context)) ...[
          ...
          searchBar(title: "Search for Purchase Order"),
          downloadBar(
            results: '27',
          ),
          Expanded(
