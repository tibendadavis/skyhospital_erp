...
class operationRoom extends StatefulWidget {
  const operationRoom({super.key});

  @override
  State<operationRoom> createState() => _operationRoomState();
}

class _operationRoomState extends State<operationRoom> {
  @override
    ...
    return Container(
      child: Expanded(
        ...
        children: [
          ...
          SizedBox(
            width: Responsive.isDesktop(context) ? size.width / 2.3 : null,
            child: Flex(
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  Expanded(
                    ...
                    link: null,
                    linkTitle: "New Operation Room",
                  )),
                  Expanded(
                      child: tile2(
                    tileHeading: "Total Rooms",
                    tileData: "10",
                  )),
                ],
                if (!Responsive.isDesktop(context)) ...[
