...
import 'package:skyhospital_erp/screens/Misc/visualTestSetting.scrn.dart';

import 'package:skyhospital_erp/theme/design.theme.dart';

class visualAcuityTest extends StatefulWidget {
  const visualAcuityTest({super.key});
            ...
            child: Flex(
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  ...
                  Expanded(
                      child: tile2(
                    tileHeading: "Test Settings",
                    tileData: "7",
                    linkTitle: "View Setings",
                    link: visualTestSetting(),
                  )),
                  Expanded(
                      child: tile2(
                          tileHeading: "Total Tests Done", tileData: "5")),
                  Expanded(
                      child: Container(
                    margin: EdgeInsets.only(right: Insets().appPadding * 2),
                    child: tile2(
                        tileHeading: "Total Pending Patients", tileData: "2"),
                  )),
                ],
                if (!Responsive.isDesktop(context)) ...[
                  Container(
                  ...
                  Container(
                      ...
                      child: tile2(
                          tileHeading: "Total Pending Patients",
                          tileData: "2")),
                ]
              ],
            ),
