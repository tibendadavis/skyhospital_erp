...
class wardBeds extends StatefulWidget {
  const wardBeds({super.key});

  @override
  State<wardBeds> createState() => _wardBedsState();
}

class _wardBedsState extends State<wardBeds> {
  @override
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  ...
                  Expanded(
                    ...
                    child: tile2(tileHeading: "Empty Beds", tileData: "13"),
                  )),
                  Expanded(
                      child: Container(
                    margin: EdgeInsets.only(right: Insets().appPadding * 2),
                    child: tile2(tileHeading: "Beds Taken", tileData: "13"),
                  )),
                ],
                if (!Responsive.isDesktop(context)) ...[
                  Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () {
                                showDialog(
                                    context: context, builder: (_) => addBed());
                              },
                  ...
                  Container(
                      ...
                      child: tile2(tileHeading: "Empty Beds", tileData: "2")),
                  Container(
                      width: MediaQuery.of(context).size.width,
                      margin: EdgeInsets.only(
                        right: Insets().appPadding,
                      ),
                      child: tile2(tileHeading: "Beds Taken", tileData: "2")),
                ]
              ],
            ),
          ),
          searchBar(
              title: "Search for  Bed",
