...
class appointmentCategory extends StatefulWidget {
  const appointmentCategory({super.key});

  @override
  State<appointmentCategory> createState() => _appointmentCategoryState();
}
    ...
    return Container(
      child: Expanded(
        ...
        children: [
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  Expanded(
                    ...
                    link: null,
                    linkTitle: "New Appointment\nCategory",
                  )),
                  Expanded(
                      child: tile2(
                          tileHeading: "Appointment Category",
                          tileData: "240")),
                ],
                if (!Responsive.isDesktop(context)) ...[
                  Container(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                              onPressed: () {
                                // showDialog(
                                //     context: context,
                                //     builder: (_) => addAppointmentCategory());
                              },
          ...
          searchBar(
            title: "Search for Appointment Category",
