...
class clinicalStaff extends StatefulWidget {
  const clinicalStaff({super.key});

  @override
  State<clinicalStaff> createState() => _clinicalStaffState();
}

class _clinicalStaffState extends State<clinicalStaff> {
  @override
          ...
          Flex(
            ...
            children: [
              if (Responsive.isDesktop(context)) ...[
                ...
                Expanded(
                    child: tile2(
                        tileHeading: "Total Clinical Staffs", tileData: "240")),
                Expanded(
                    child: tile2(
                        tileHeading: "Total Male Clinical Staffs",
                        tileData: "120")),
                Expanded(
                    child: Container(
                  margin: EdgeInsets.only(right: Insets().appPadding * 2),
                  child: tile2(
                      tileHeading: "Total Female Clinical Staffs",
                      tileData: "120"),
                ))
              ],
              if (!Responsive.isDesktop(context)) ...[
                    ...
                    Expanded(
                        ...
                        child: TextFormField(
                            decoration: const InputDecoration(
                                ...
                                hintText: " Search for Clinical Staff",
