...
import 'package:skyhospital_erp/screens/Login/loading.scrn.dart';
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage("assets/img/skyHospitalbgLogin.jpg"),
                  fit: BoxFit.cover),
            ),
            child: Row(
              ...
              children: [
                Container(
                  width: !Responsive.isMobile(context) ? 450 : size.width - 30,
                  height: size.height,
                  margin: EdgeInsets.only(
                      right: !Responsive.isMobile(context) ? 100 : 0,
                      top: 20,
                      bottom: 20),
