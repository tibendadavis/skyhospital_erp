...
import 'package:skyhospital_erp/screens/System%20Configuration/addDistrict.scrn.dart';

import 'package:skyhospital_erp/theme/design.theme.dart';

class regionDistricts extends StatefulWidget {
  const regionDistricts({super.key});

  @override
  State<regionDistricts> createState() => _regionDistrictsState();
}

class _regionDistrictsState extends State<regionDistricts> {
  @override
    ...
    return Container(
      child: Expanded(
        ...
        children: [
              ...
              children: [
                if (Responsive.isDesktop(context)) ...[
                  Expanded(
                    ...
                    link: addDistrict(),
                    linkTitle: "New District",
                  )),
                  Expanded(
                      child: tile2(
                    tileHeading: "Total Districts",
                    tileData: "7",
                  )),
                ],
                if (!Responsive.isDesktop(context)) ...[
          ...
          searchBar(title: "Search for Region / Districts"),
          downloadBar(
            results: '27',
          ),
          Expanded(
