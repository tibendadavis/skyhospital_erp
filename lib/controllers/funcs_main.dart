...
class Funcs {
  ...
  int? monthSelect(String _month) {
    int? month;
    if (_month == "January") month = DateTime.january;

    if (_month == "February") month = DateTime.february;

    if (_month == "March") month = DateTime.march;

    if (_month == "April") month = DateTime.april;

    if (_month == "May") month = DateTime.may;

    if (_month == "June") month = DateTime.june;

    if (_month == "July") month = DateTime.july;

    if (_month == "August") month = DateTime.august;

    if (_month == "September") month = DateTime.september;

    if (_month == "October") month = DateTime.october;

    if (_month == "November") month = DateTime.november;

    if (_month == "December") month = DateTime.december;

    return month;
  }

  int? yearSelect(String _year) {
    int? year;
    if (_year == "2023") year = 2023;

    if (_year == "2022") year = 2022;

    if (_year == "2021") year = 2021;

    if (_year == "2020") year = 2020;

    if (_year == "2019") year = 2019;

    if (_year == "2018") year = 2018;

    if (_year == "2017") year = 2017;

    if (_year == "2016") year = 2016;

    if (_year == "2015") year = 2015;

    if (_year == "2014") year = 2014;

    if (_year == "2013") year = 2013;

    if (_year == "2012") year = 2012;
